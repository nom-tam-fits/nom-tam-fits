...
public class HeaderTest {
    ...
    public void before() throws Exception {
        ...
        Fits f = new Fits(); BufferedFile bf = new BufferedFile("target/ht1.fits", "rw");
    ...
    public void addValueTests() throws Exception {
        FileInputStream in = new FileInputStream("target/ht1.fits"); Fits fits = new Fits();
        fits.read(in);
    ...
    public void truncatedFileExceptionTest() throws Exception {
        FileInputStream f = new FileInputStream("target/ht1.fits");//
        ...
        Fits fits = new Fits("target/ht1_truncated.fits");
