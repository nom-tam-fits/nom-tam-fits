...
import nom.tam.fits.compression.gzip.GZipCompressor.ByteGZipCompressor;
import nom.tam.fits.compression.gzip.GZipCompressor.DoubleGZipCompressor;
import nom.tam.fits.compression.gzip.GZipCompressor.FloatGZipCompressor;
import nom.tam.fits.compression.gzip.GZipCompressor.IntGZipCompressor;
import nom.tam.fits.compression.gzip.GZipCompressor.LongGZipCompressor;
import nom.tam.fits.compression.gzip.GZipCompressor.ShortGZipCompressor;
import nom.tam.fits.compression.gzip2.GZip2Compressor.IntGZip2Compressor;
import nom.tam.fits.compression.gzip2.GZip2Compressor.LongGZip2Compressor;
import nom.tam.fits.compression.gzip2.GZip2Compressor.ShortGZip2Compressor;
import nom.tam.fits.compression.hcompress.HCompressor.ByteHCompressor;
import nom.tam.fits.compression.hcompress.HCompressor.DoubleHCompressor;
import nom.tam.fits.compression.hcompress.HCompressor.FloatHCompressor;
import nom.tam.fits.compression.hcompress.HCompressor.IntHCompressor;
import nom.tam.fits.compression.hcompress.HCompressor.ShortHCompressor;
import nom.tam.fits.compression.plio.PLIOCompress.BytePLIOCompressor;
import nom.tam.fits.compression.plio.PLIOCompress.IntPLIOCompressor;
import nom.tam.fits.compression.plio.PLIOCompress.ShortPLIOCompressor;
...
import nom.tam.fits.compression.rice.RiceCompressor.ByteRiceCompressor;
import nom.tam.fits.compression.rice.RiceCompressor.DoubleRiceCompressor;
import nom.tam.fits.compression.rice.RiceCompressor.FloatRiceCompressor;
import nom.tam.fits.compression.rice.RiceCompressor.IntRiceCompressor;
import nom.tam.fits.compression.rice.RiceCompressor.ShortRiceCompressor;
