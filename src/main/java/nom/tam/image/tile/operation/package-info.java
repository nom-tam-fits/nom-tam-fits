/**
 * <p>
 * Interfaces and base classes for handling image tiles (<i>primarily for internal use</i>) . It's weird that these
 * classes aren't bundled with the rest of the tiling support, but that's life.
 * </p>
 * <p>
