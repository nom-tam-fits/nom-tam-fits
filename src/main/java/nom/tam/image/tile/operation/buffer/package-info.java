/**
 * <p>
 * (<i>for internal use</i>) Buffering support for image tiles. It's weird that these classes aren't bundled with the
 * rest of the tiling support, but that's life.
 * </p>
 * <p>
