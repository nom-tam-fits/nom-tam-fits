...
<a href="https://doi.org/10.5281/zenodo.14901859">
 <img src="https://zenodo.org/badge/DOI/10.5281/zenodo.14901859.svg" alt="DOI: 10.5281/zenodo.14901859"/>
</a>
...
[Attila Kov&aacute;cs](https://github.com/attipaci).

This document has been updated for 1.22 and/or later 1.x releases.
...
the users to extract or complete the description of data to its full extent, for example to include [FITS world 
coordinate systems (WCS)](https://fits.gsfc.nasa.gov/fits_wcs.html), physical units, etc. Users are encouraged to 
